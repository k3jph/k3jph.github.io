...
:::figure{src="/assets/img/news/dna-3656587_1280.webp" alt="Rendering of DNA" align="left" width="50%"}
Rendering of DNA
:::
...
:::figure{src="/assets/img/news/960px-Difference_DNA_RNA-EN.svg.webp" alt="Differences between DNA and RNA (via Sponk/Wikimedia Commons)" align="center" width="100%"}
Differences between DNA and RNA (via <a href='https://commons.wikimedia.org/wiki/File:Difference_DNA_RNA-EN.svg'>Sponk/Wikimedia Commons</a>)
:::
...
:::figure{src="/assets/img/news/pexels-cdc-3992933.webp" alt="Rendering of the SARS-CoV-2 virus (via the CDC)" align="right" width="50%"}
Rendering of the SARS-CoV-2 virus (via the CDC)
:::
