...
<div class="text-center">[latex]L_p = 20\log_{10} \frac{p}{p_0}\,\text{dB.} [/latex]</div>
...
<div class="text-center">[latex]M_j = \log_{10} \frac{M_J}{M_\oplus} = \log_{10} \frac{1.898\times 10^{27}\,\text{kg}}{5.972\times 10^{24}\,\text{kg}} \approx 2.5\,\text{dB.}[/latex]</div>
