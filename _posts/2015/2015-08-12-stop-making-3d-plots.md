...
dsq_thread_id:
  - "4025721114"
featured_image: /assets/img/news/XKCD-Self-Description.webp
categories:
  - Blog
tags:
  - data science
...
{% include figure.html image="news/samplepiechart.webp" alt="An example pie chart" cap="An example pie chart" %}
...
{% include figure.html image="news/samplebarchart.webp" alt="An example bar chart" cap="An example bar chart" %}
