...
In a proof, I would write \\(\lim_{n \rightarrow \infty}{AC} = \lim_{n \rightarrow \infty}{VC + FC / n} = VC + 0 = VC\\), LaTeX it, and
...
At this point, I've fairly well convinced the class that \\(AC = VC = MC\\) and am starting on the price when I hear a student note that
